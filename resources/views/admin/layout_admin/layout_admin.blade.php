...
<head>
    ...
    <title>Quản trị Autocad123</title>
        ...
        <div class="navbar-brand-wrapper">
            ...
            <a class="navbar-brand" href="" aria-label="Front">
                <img
                    ...
                    src="https://rdsic.edu.vn/img/logo.png"
                    alt="Logo"
                />
                <img
                           ...
                           data-hs-unfold-target="#accountNavbarDropdown" data-hs-unfold-invoker="">
                            <div class="avatar avatar-sm avatar-circle">
                                <img class="avatar-img"
                                     src="{{Request::root().'/images/2022-07-05-1657038245-post_img1.jpg'}}"
                    ...
                    <li class="navbar-vertical-aside-has-menu ">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                            ...
                            <li class="nav-item">
                                <a
                                    class="nav-link "
                                    href="{{Request::root().'/admin/trang-chu'}}"
                                    title="Calendar"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                        ...
                        ></span
                            ...
                            <li class="nav-item">
                                <a
                                    class="nav-link "
                                    href="{{Request::root().'/admin/thong-ke-view-bai-viet/?start='.date('Y-m-d').'&end='.date('Y-m-d')}}"
                                    title="Calendar"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate"
...
{{--                                <a--}}
{{--                                    class="nav-link "--}}
{{--                                    href="{{Request::root().'/admin/them-huong-dan'}}"--}}
{{--                                    title="Kanban"--}}
{{--                                >--}}
{{--                                    <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                    <span class="text-truncate">Thêm AF</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a--}}
{{--                                    class="nav-link "--}}
{{--                                    href="{{Request::root().'/admin/bai-huong-dan'}}"--}}
{{--                                    title="Calendar"--}}
{{--                                >--}}
{{--                                    <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                    <span class="text-truncate"--}}
...
{{--                                <a--}}
{{--                                    class="nav-link "--}}
{{--                                    href="{{Request::root().'/admin/thong-ke-view-bai-viet-hd/?start='.date('Y-m-d').'&end='.date('Y-m-d')}}"--}}
{{--                                    title="Kanban"--}}
{{--                                >--}}
{{--                                    <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                    <span class="text-truncate">Thống kê view</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                        </ul>--}}
{{--                    </li>--}}
...
{{--                                <a--}}
{{--                                    class="nav-link "--}}
{{--                                    href="{{Request::root().'/admin/them-key'}}"--}}
{{--                                    title="Kanban"--}}
{{--                                >--}}
{{--                                    <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                    <span class="text-truncate">Thêm Key</span>--}}
{{--                                </a>--}}
{{--                            </li>--}}
{{--                            <li class="nav-item">--}}
{{--                                <a--}}
{{--                                    class="nav-link "--}}
{{--                                    href="{{Request::root().'/admin/danh-sach-key'}}"--}}
{{--                                    title="Calendar"--}}
{{--                                >--}}
{{--                                    <span class="tio-circle nav-indicator-icon"></span>--}}
{{--                                    <span class="text-truncate">--}}
                    ...
                    <li class="navbar-vertical-aside-has-menu ">
                        ...
                        <ul class="js-navbar-vertical-aside-submenu nav nav-sub">
                            <li class="nav-item">
                                <a
                                    class="nav-link "
                                    href="{{Request::root().'/rd/xml/a/clear-cache'}}"
                                    title="Kanban"
                                    target="_blank"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">Clear cache</span>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a
                            ...
                            <li class="nav-item">
                                <a
                                    class="nav-link "
                                    target="_blank"
                                    href="{{Request::root().'/admin/them-banner'}}"
                                    title="Calendar"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">
                            ...
                            <li class="nav-item">
                                <a
                                    class="nav-link "
                                    target="_blank"
                                    href="{{route('displayFooter')}}"
                                    title="Calendar"
                                >
                                    <span class="tio-circle nav-indicator-icon"></span>
                                    <span class="text-truncate">
                                        Thêm code vào footer
                                    </span>
                                </a>
                            </li>
...
<script>
    ...
    async function getData(json) {
        ...
        for (let item of json) {
            ...
            await fetch('http://topviews.test/api/rd/xml/a/import', options)
                .then(response => {
        ...
        await fetch('http://topviews.test/api/rd/xml/a/create')
            .then(response => {
                console.log('55')
                $('.sspinner').addClass('d-none')
...
{{--        }--}}
{{--        await fetch('http://rdone.test/api/rd/xml/a/import', options)--}}
{{--            .then(response => {--}}
...
{{--        await fetch('http://rdone.test/api/rd/xml/a/create')--}}
{{--            .then(response => {--}}
{{--                console.log('55')--}}
{{--                $('.sspinner').addClass('d-none')--}}
{{--                alert("Đã import xong");--}}
