...
@section('main')
    ...
    <div class="col-lg-12">
        ...
        <div class="card card-lg mb-3 mb-lg-5">
            <form action="{{route('updateRo')}}" method="post" enctype="multipart/form-data">
            @csrf
            <!-- Header -->
                <div class="card-header">
                    <h4 class="card-header-title">Sửa file robots.txt</h4>
                </div>
                <!-- End Header -->
                ...
                <div class="card-body">
                    ...
                    <div class="form-group">
                        <textarea name="noi_dung_robot" class="form-control" placeholder="Textarea field" rows="10">{{$content}}</textarea>
                    </div>
