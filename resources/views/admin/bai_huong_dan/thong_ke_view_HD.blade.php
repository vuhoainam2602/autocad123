...
@section("main")
        ...
        <div class="card-header">
            <div class="row justify-content-between align-items-center flex-grow-1">
                ...
                <div class="col-sm-6 col-md-4 mb-3 mb-sm-0 d-flex justify-content-end">
                    ...
                    <a href="https://rdone.net/admin/them-huong-dan" class="btn btn-primary pt-1 pb-1 pr-2 pl-2">Thêm
                        mới</a>
                </div>
            </div>
            <!-- End Row -->
                    ...
                    @foreach ($ds_bai_viet as $item)
                        <tr role="row" class="odd">
                            ...
                            @if($str_start == $str_end)
                                @if(!empty(json_decode($item->postHD_view,true)[$str_start]))
                                    <td class="text-center">{{json_decode($item->postHD_view,true)[$str_start]}}</td>
                                @else
                            ...
                            @else
                                ...
                                for ($i = 0; $i <= (int)$m_end - (int)$m_start; $i++) {
                                    ...
                                    if (!empty(json_decode($item->postHD_view, true)[$tg])) {
                                        $count += (int)json_decode($item->postHD_view, true)[$tg];
                                    }
                                }
                                echo $count;
                                ?>
                            ...
                            <td>
                                @if(session()->get('role')[0] == 'admin' || session()->get('role')[0] == 'nv')
                                    <a class="btn btn-sm btn-white" href="{{Request::root()."/hd/".$item->postHD_name}}">
    ...
    <script type="text/javascript">
        ...
        $("#loc").click(function () {
            ...
            window.location.href = URL_Base + '/admin/thong-ke-view-bai-viet-hd/?start='
